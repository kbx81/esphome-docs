...
.. raw:: html
    ...
    <div class="guide-container">
        <div class="guide-card">
            ...
            <ul>
                <li>
                    <a class="reference" href="/docs/guides/getting_started_hassio.html">
                        from Home Assistant
                    </a>
                </li>
                <li>
                    <a class="reference" href="/docs/guides/getting_started_command_line.html">
                ...
                <li>
                    <a class="reference" href="/docs/guides/migrate_sonoff_tasmota.html">
        ...
        <div class="guide-card">
            ...
            <ul>
                <li>
                    <a class="reference" href="/docs/guides/faq.html">
                        FAQ and Tips
                    </a>
                </li>
                <li>
                    <a class="reference" href="/docs/automations/index.html">
                        Automations
                    </a>
                </li>
                <li>
                    <a class="reference" href="/docs/guides/diy.html">
                        DIY Examples
                    </a>
                </li>
                <li>
                    <a class="reference" href="/docs/guides/configuration-types.html">
                        Configuration types
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a class="reference" href="/docs/guides/creators.html">
                        Sharing ESPHome devices
                    </a>
                </li>
                <li>
                    <a class="reference" href="/docs/guides/made_for_esphome.html">
        ...
        <div class="guide-card">
            ...
            <ul>
                ...
                <li>
                    <a class="reference" href="/docs/guides/supporters.html">
                        Supporters
                    </a>
                </li>
                <li>
                    <a class="reference" href="/docs/guides/contributing.html">
                        Contributing
                    </a>
                </li>
            </ul>
...
You will find all :doc:`ESPHome documentation here</docs/index>`.
