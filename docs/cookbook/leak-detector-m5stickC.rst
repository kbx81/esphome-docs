...
You'll need to place the `OpenSans-Regular <https://fonts.google.com/specimen/Open+Sans>`__ font (or another of your choosing) alongside your ESPHome yaml file.  See - :doc:`/docs/components/display/index`.
...
- :doc:`/docs/components/display/st7735`
- :doc:`/docs/components/binary_sensor/esp32_touch`
- :ghedit:`Edit`
