...
For ESPHome, you can then use the :doc:`pulse meter sensor </docs/components/sensor/pulse_meter>` using below configuration:
...
Additionally you can also calculate the total daily energy generated, for which you can use the :doc:`Total Daily Energy </docs/components/sensor/total_daily_energy>` using below configuration:
...
- :doc:`/docs/components/sensor/pulse_counter`
- :doc:`/docs/components/sensor/pulse_meter`
- :doc:`/docs/components/sensor/total_daily_energy`
- :doc:`/docs/components/time/homeassistant`
