...
.. seo::
    ...
    :image: /docs/cookbook/images/infostrip-detail.jpg
    :keywords: Neopixel
...
.. warning::
    ...
    Consider the warning in :doc:`/docs/components/light/partition` regarging the increased memory usage.
...
- :doc:`/docs/components/light/fastled`
- :doc:`/docs/components/light/partition`
- :doc:`/docs/components/sensor/mhz19`
- :ghedit:`Edit`
