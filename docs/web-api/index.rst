...
or using the :doc:`Web Server Section </docs/components/web_server>` in ESPHome.
...
- :doc:`/docs/components/web_server`
- :doc:`/docs/components/prometheus`
- :doc:`/docs/components/http_request`
- :ghedit:`Edit`
