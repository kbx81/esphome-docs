...
:doc:`/docs/components/safe_mode` for details.
...
-  All :ref:`automations <automation>` supported by :doc:`/docs/components/ota/index`.
...
- :doc:`/docs/components/ota/index`
- :doc:`/docs/components/ota/http_request`
- :doc:`/docs/components/safe_mode`
- :ghedit:`Edit`
