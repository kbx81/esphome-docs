...
Images may be used in LVGL configurations wherever an image is required. See the :doc:`LVGL </docs/components/lvgl/index>` documentation for more information.
