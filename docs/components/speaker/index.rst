...
- **audio_dac** (*Optional*, :ref:`config-id`): The :doc:`audio DAC </docs/components/audio_dac/index>` to use for volume control.
...
- :doc:`/docs/guides/audio_clips_for_i2s`
- :doc:`/docs/components/speaker/i2s_audio`
- :ghedit:`Edit`
