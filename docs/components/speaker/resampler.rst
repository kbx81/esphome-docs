...
The ``resampler`` speaker platform allows you to convert the sample rate of an audio stream and output it to another :doc:`speaker component </docs/components/speaker/index>`.
...
- **output_speaker** (**Required**, :ref:`config-id`): The :doc:`speaker </docs/components/speaker/index>` to output the resampled audio.
