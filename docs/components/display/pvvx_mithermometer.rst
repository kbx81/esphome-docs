...
.. seo::
    ...
    :image: /docs/components/sensor/images/xiaomi_lywsd03mmc.jpg
...
.. figure:: /docs/components/sensor/images/xiaomi_lywsd03mmc.jpg
    :align: center
    :width: 75.0%
...
- **time_id** (*Optional*, :ref:`config-id`): ID of a :doc:`/docs/components/time/index`. If set, the time will be synchronized with every connection.
...
- :doc:`index`
- :doc:`/docs/components/ble_client`
- :doc:`/docs/components/sensor/xiaomi_ble`
