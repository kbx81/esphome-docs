...
logging or other :doc:`automations</docs/automations/index>` will occur. This process uses the same protocol as the
...
We suggest using a :doc:`/docs/components/button/template` to trigger this process. For example:
