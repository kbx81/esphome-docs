...
- **power_supply** (*Optional*, :ref:`config-id`): The :doc:`power supply </docs/components/power_supply>` to connect to
...
- :doc:`index`
- :doc:`Power Supply Component </docs/components/power_supply>`
