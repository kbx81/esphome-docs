...
- :doc:`LVGL </docs/components/lvgl/index>` - Light and Versatile Graphics Library
...
.. note::
    ...
    you can use the :doc:`/docs/components/text_sensor/mqtt_subscribe` (see the example there for more information).
...
- :doc:`LVGL </docs/components/lvgl/index>`
