...
It provides the combined functionality of :doc:`status_led component </docs/components/status_led>` and a
:doc:`binary light component </docs/components/light/binary>` over a single shared GPIO led.
...
- :doc:`/docs/components/status_led`
