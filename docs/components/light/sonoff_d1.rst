...
- :doc:`logger </docs/components/logger>` to the serial port is disabled by setting ``baud_rate`` to ``0``
- in case you need light state restoration on power up, make sure ``restore_from_flash`` is set to ``true`` in the :doc:`ESP8266 platform </docs/components/esp8266>`
...
- :doc:`/docs/components/uart`
- :doc:`/docs/components/logger`
- :doc:`/docs/components/esp8266`
- :ghedit:`Edit`
