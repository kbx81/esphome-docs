...
You could also send the value to Home Assistant via a :doc:`template sensor </docs/components/sensor/template>`:
...
:doc:`button </docs/components/button/index>` is a great mechanism to use to trigger these actions.
