...
.. note::
    ...
    **USE WITH GREAT CAUTION!** All credentials, global variables, counters and saved states stored in non-volatile memory will be lost with no chance of recovering them.
    ...
    For devices configured using :doc:`captive portal </docs/components/captive_portal>`, this will reset WiFi settings as well, thus making such devices offline.
...
- :doc:`restart`
- :doc:`safe_mode`
- :doc:`/docs/components/switch/factory_reset`
- :doc:`template`
