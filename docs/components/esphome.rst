...
For :doc:`ESP8266 </docs/components/esp8266>`, ``restore_from_flash`` must also be set to ``true`` for states to be written to flash.
...
Using ``name_add_mac_suffix`` allows :doc:`creators </docs/guides/creators>` to
