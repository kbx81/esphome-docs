...
This allows the playback of audio via the microcontroller from a range of sources via :doc:`/docs/components/speaker/index` or
:doc:`/docs/components/media_player/index`.
