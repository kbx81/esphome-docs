...
a tuya serial component. This platform requires :doc:`/docs/components/tuya` to be configured.

When :doc:`/docs/components/tuya` has been properly configured, it will output a list of
...
- :doc:`/docs/components/number/index`
