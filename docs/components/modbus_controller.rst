...
To choose the role, set the ``role`` attribute of the :doc:`/docs/components/modbus` upon which this ``modbus_controller`` component relies. ``client`` is the default.

.. figure:: /docs/images/modbus.png
    :align: center
    :width: 25%
...
- :doc:`/docs/components/modbus`
- :doc:`/docs/components/sensor/modbus_controller`
- :doc:`/docs/components/binary_sensor/modbus_controller`
- :doc:`/docs/components/output/modbus_controller`
- :doc:`/docs/components/switch/modbus_controller`
- :doc:`/docs/components/number/modbus_controller`
- :doc:`/docs/components/select/modbus_controller`
- :doc:`/docs/components/text_sensor/modbus_controller`
