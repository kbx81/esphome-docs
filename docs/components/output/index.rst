...
- **power_supply** (*Optional*, :ref:`config-id`): The :doc:`power
  supply </docs/components/power_supply>` to connect to
...
works with floating point outputs like :doc:`/docs/components/output/esp8266_pwm`, :doc:`/docs/components/output/ledc`, :doc:`/docs/components/output/sigma_delta_output`, :doc:`/docs/components/output/slow_pwm`.
