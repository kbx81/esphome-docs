...
to output a floating-point value on a binary output. Unlike with :doc:`/docs/components/output/slow_pwm`,
...
PWM period of 10 seconds, for reasonably frequent updates, with :doc:`/docs/components/output/slow_pwm`
...
This component can be used as a drop-in replacement for :doc:`/docs/components/output/slow_pwm` by changing the ``platform`` to
...
.. note::
    ...
    to be off for a while to e.g. cool down, :doc:`/docs/components/output/slow_pwm`
...
- :doc:`/docs/components/output/slow_pwm`
- :doc:`/docs/components/light/monochromatic`
- :doc:`/docs/components/fan/speed`
