...
The Tuya fan requires a :doc:`/docs/components/tuya` to be configured.
...
- 9 represents the additional light switch. (use the :doc:`/docs/components/light/tuya` component to control this)
