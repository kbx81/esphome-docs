...
You can also force the invocation of safe mode by configuring a dedicated :doc:`button</docs/components/button/safe_mode>`
or :doc:`switch</docs/components/switch/safe_mode>` component and/or by repeatedly pressing the reset button on the board
...
-  **disabled** (*Optional*, boolean): Set to ``true`` to disable safe_mode. :doc:`/docs/components/ota/index` automatically
...
- :doc:`/docs/components/button/safe_mode`
- :doc:`/docs/components/switch/safe_mode`
- :ghedit:`Edit`
