...
The ``speaker`` media player platform allows you to play on-device and online audio media via :doc:`speaker components </docs/components/speaker/index>`.
...
It supports two different audio pipelines: announcement and media. Each audio pipeline must output to a unique speaker. Use a :doc:`mixer speaker </docs/components/speaker/mixer>` component to create two different speakers that output to a single audio speaker.
...
- **announcement_pipeline** (**Required**, Pipeline Schema): Configuration settings for the announcement pipeline.
  ...
  - **speaker** (**Required**, :ref:`config-id`): The :doc:`speaker </docs/components/speaker/index>` to output the audio.
...
- :doc:`/docs/components/speaker/index`
- :doc:`/docs/components/speaker/mixer`
- :doc:`/docs/components/speaker/resampler`
- :doc:`index`
- :ghedit:`Edit`
