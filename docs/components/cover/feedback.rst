...
It is a drop-in replacement of :doc:`/docs/components/cover/time_based`
...
It is a drop-in replacement of :doc:`/docs/components/cover/endstop`.
...
It can be used to replace a :doc:`/docs/components/cover/current_based`, with some modifications in the yaml. See :ref:`migrating_current_based`
...
1. All current sensing related options must be moved to auxiliary :doc:`/docs/components/binary_sensor/analog_threshold`,
