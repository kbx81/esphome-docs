...
(thanks to an embedded :doc:`ADE7953 </docs/components/sensor/ade7953>`) in a very small form factor (39mm x 36mm x 17 mm).
It also features an :doc:`NTC temperature sensor </docs/components/sensor/ntc>`.
...
.. warning::
    ...
    The ADE7953 IRQ line is connected to the GPIO16. The ``irq_pin`` parameter for the :doc:`ADE7953 </docs/components/sensor/ade7953>` MUST be
...
- :doc:`index`
- :doc:`/docs/components/cover/template`
- :doc:`/docs/components/sensor/ade7953`
- :ref:`automation`
