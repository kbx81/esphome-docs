...
this component. Please see the :doc:`/docs/components/ble_client` docs for how to discover the MAC
...
- **time_id** (*Optional*, :ref:`config-id`): The ID of a :doc:`/docs/components/time/index` which
...
.. note::
    ...
    To set up a (dis-)connect switch, see :doc:`/docs/components/switch/ble_client`.
