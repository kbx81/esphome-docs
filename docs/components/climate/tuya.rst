...
Tuya climate requires a :doc:`/docs/components/tuya` to be configured.
...
- 6 represents the child lock switch. (use the :doc:`/docs/components/switch/tuya` component to control this)
