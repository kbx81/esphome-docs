...
This component requires that you have configured a :doc:`/docs/components/remote_transmitter`.
...
However, when receiver is supported, you can optionally add a :doc:`/docs/components/remote_receiver`
...
.. note::
    ...
    - The ``RAC-PT1411HWRU`` model supports a feature Toshiba calls "Comfort Sense". The handheld remote control
      ...
      internal temperature sensor; a value of 30 seconds seems to work well. See :doc:`/docs/components/sensor/index`
...
for example what mode the device is in). By setting up a :doc:`remote_receiver </docs/components/remote_receiver>`
...
.. note::
    ...
    internal temperature sensor; a value of 2 minutes seems to work well. See :doc:`/docs/components/sensor/index`
    for more information.

See Also
--------

- :doc:`/docs/components/climate/index`
- :doc:`/docs/components/remote_receiver`
- :doc:`/docs/components/remote_transmitter`
- :doc:`/docs/components/sensor/index`
