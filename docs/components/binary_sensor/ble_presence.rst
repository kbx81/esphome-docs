...
-  Create an iBeacon and track it based on its iBeacon UUID. You can also optionally specify
   ...
   functionality via the :doc:`ESP32 Bluetooth Low Energy Beacon </docs/components/esp32_ble_beacon>`
...
- :doc:`/docs/components/esp32_ble_beacon`
- :doc:`/docs/components/binary_sensor/index`
