...
.. note::
    ...
    If your device has a single LED that needs to be shared use  :doc:`status_led light platform </docs/components/light/status_led>` instead.
...
- :doc:`/docs/components/light/status_led`
