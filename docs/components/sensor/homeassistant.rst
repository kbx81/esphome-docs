...
states from your Home Assistant instance using the :doc:`native API </docs/components/api>`.
...
.. note::
    ...
    from Home Assistant, use the :doc:`Home Assistant Text Sensor </docs/components/text_sensor/homeassistant>`.
