...
:doc:`/docs/components/esp32_ble_tracker`. This component will track the tank level,
...
.. warning::
    ...
    See :doc:`/docs/components/sensor/mopeka_pro_check` for Mopeka Pro Check sensors support.
