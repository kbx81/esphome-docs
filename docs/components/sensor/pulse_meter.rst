...
for the :doc:`pulse counter component </docs/components/sensor/pulse_counter>`.
...
.. figure:: /docs/images/pulse-counter_vs_pulse-meter.png
    :align: center
    :width: 50.0%
