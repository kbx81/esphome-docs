...
To maximize the chances of catching advertisements of the sensors, you can set ``interval`` equal to ``window`` in :doc:`/docs/components/esp32_ble_tracker` scan parameter settings:
...
- :doc:`/docs/components/esp32_ble_tracker`
- :doc:`/docs/components/sensor/index`
- :doc:`/docs/components/display/pvvx_mithermometer`
- :apiref:`xiaomi_lywsd03mmc/xiaomi_ble.h`
- :doc:`/docs/components/ethernet`
- :doc:`/docs/components/bluetooth_proxy`
