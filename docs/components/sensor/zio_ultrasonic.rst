...
The Zio Ultrasonic Distance Sensor is an ultrasonic distance sensor based on the HC-SR04 sensor. Unlike the :doc:`Ultrasonic Distance Sensor component </docs/components/sensor/ultrasonic>`, measurements are read over the I²C bus.
...
- :doc:`Ultrasonic Sensor Component </docs/components/sensor/ultrasonic>`
- :ref:`sensor-filters`
- :doc:`template`
- :ghedit:`Edit`
