...
Energy devices using the :doc:`/docs/components/esp32_ble_tracker`. This component
...
.. warning::
    ...
    See :doc:`/docs/components/sensor/mopeka_std_check` for original Mopeka Check sensors support.
