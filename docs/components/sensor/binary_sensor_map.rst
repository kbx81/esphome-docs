...
The ``binary_sensor_map`` sensor platform allows you to map multiple :doc:`binary sensor </docs/components/binary_sensor/index>`
...
- **channels** (**Required for GROUP or SUM types**): A list of channels that are mapped to certain values.
  ...
  - **binary_sensor** (**Required**): The id of the :doc:`binary sensor </docs/components/binary_sensor/index>`
...
- :doc:`/docs/components/binary_sensor/mpr121`
- :doc:`/docs/components/binary_sensor/analog_threshold`
- :ref:`sensor-filters`
