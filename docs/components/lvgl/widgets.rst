...
.. note::
    ...
    LVGL only supports **integers** for numeric ``value``. Visualizer widgets can't display floats directly, but they allow scaling by 10s. Some examples in the :doc:`Cookbook </docs/cookbook/lvgl>` cover how to do that.
...
.. figure:: images/lvgl_animimg.gif
    :align: center
...
The ``arc`` can be also integrated as a :doc:`Number </docs/components/number/lvgl>` or :doc:`Sensor </docs/components/sensor/lvgl>` component.
...
The ``bar`` can be also integrated as :doc:`Number </docs/components/number/lvgl>` or :doc:`Sensor </docs/components/sensor/lvgl>` component.
...
The ``button`` can be also integrated as a :doc:`Binary Sensor </docs/components/binary_sensor/lvgl>` or as a :doc:`Switch </docs/components/switch/lvgl>` component.
...
.. figure:: images/lvgl_buttonmatrix.png
    :align: center
...
.. figure:: images/lvgl_checkbox.png
    :align: center
...
The ``checkbox`` can be also integrated as a :doc:`Switch </docs/components/switch/lvgl>` component.
...
.. figure:: images/lvgl_dropdown.png
    :align: center
...
The ``dropdown`` can be also integrated as :doc:`Select </docs/components/select/lvgl>` component.
...
.. figure:: images/lvgl_keyboard.png
    :align: center
...
The ``label`` can be also integrated as :doc:`Text </docs/components/text/lvgl>` or :doc:`Text Sensor </docs/components/text_sensor/lvgl>` component.
...
The ``led`` can be also integrated as :doc:`Light </docs/components/light/lvgl>` component.
...
.. figure:: images/lvgl_baseobj.png
    :align: center
...
The ``roller`` can be also integrated as :doc:`Select </docs/components/select/lvgl>` component.
...
The ``slider`` can be also integrated as :doc:`Number </docs/components/number/lvgl>` or :doc:`Sensor </docs/components/sensor/lvgl>` component.
...
.. figure:: images/lvgl_spinbox.png
    :align: center
...
The ``spinbox`` can be also integrated as a :doc:`Number </docs/components/number/lvgl>` or :doc:`Sensor </docs/components/sensor/lvgl>` component.
...
.. figure:: images/lvgl_spinner.gif
    :align: center
...
The ``switch`` can be also integrated as a :doc:`Switch </docs/components/switch/lvgl>` component.
...
.. figure:: images/lvgl_tabview.png
    :align: center
...
- **tabs** (**Required**, list): A list with (any number of) tabs to be added to tabview.
    ...
    - **widgets** (**Required**, list): A list of :doc:`widgets` to be drawn on the tab, as children.
...
.. figure:: images/lvgl_textarea.png
    :align: center
...
The ``textarea`` can be also integrated as :doc:`Text </docs/components/text/lvgl>` or :doc:`Text Sensor </docs/components/text_sensor/lvgl>` component.
...
- **tiles** (**Required**, list): A list with (any number of) tiles to be added to tileview.
    ...
    - **widgets** (*Optional*, list): A list of :doc:`widgets` to be drawn on the tile, as children.
