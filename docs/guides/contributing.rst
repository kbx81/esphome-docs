...
- **References**: To reference another document, use the ``:doc:`` and ``:ref:`` roles (references are set up globally
  ...
  .. code-block:: rst
      ...
      See :ref:`my-reference-label`, also see :doc:`/docs/components/switch/gpio`.
      :doc:`Using custom text </docs/components/switch/gpio>`.

  See :ref:`devices`, also see :doc:`/docs/components/switch/gpio`.
  :doc:`Using custom text </docs/components/switch/gpio>`.
...
:doc:`/docs/components/external_components` and can easily be added into your configuration for testing, like this:
...
.. note::
    ...
    For testing, you can use :doc:`/docs/components/external_components`.
...
component/platform itself as well as all :doc:`automations</docs/automations/actions>` it implements.
...
:doc:`/docs/components/substitutions`). This allows the test YAML file to reference and include the shared configuration.
...
should be added to/omitted from the list above as appropriate. The :doc:`/docs/components/sensor/adc` is one example of this.
...
:doc:`/docs/components/external_components` and offered a way to "hack in" support for devices which were not officially
...
- :doc:`/docs/components/external_components` initially require a bit more effort by the developer but are ultimately more
...
other hand, :doc:`/docs/components/external_components` are just like any other ESPHome component -- the only difference is
...
As such, most custom components can be made into :doc:`/docs/components/external_components` simply by adding the required
...
:doc:`/docs/components/external_components`; doing so will make your custom component easier to share and use. As you do so,
...
custom component. For common hardware devices such as :doc:`sensors</docs/components/sensor/index>`, this is often a
