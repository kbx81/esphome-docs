...
device, you can use :doc:`/docs/components/ota/index` to upload new
...
and connected it to your WiFi, you can use :doc:`/docs/components/ota/index` to
...
.. warning::
    ...
    .. image:: /docs/images/high-voltage-warning.svg
...
.. figure:: /docs/images/nodemcu_esp8266.jpg
    :align: center
    :width: 75.0%
...
:doc:`Read more here. </docs/guides/devboard_as_flasher>`
...
.. list-table::
    ...
    * - :ref:`USB to micro-USB/mini-USB/USB-C <usb-cable>`
      ...
      - $3 to $10
      - .. image:: /docs/guides/images/usb-cable.jpg
    ...
    * - :ref:`USB to serial adapter <usb-serial-adapter>`
      - Serial communication is a simple way of talking to other devices, like
        ...
        :doc:`Read instructions here. </docs/guides/devboard_as_flasher>`
      - $3 to $10
      - .. image:: /docs/guides/images/usb-serial-adapter.jpg
    ...
    * - :ref:`Jumper wires <jumper-wires>`
      - Used to connect two things together electrically. The male end has metal
        ...
        do.
      - $3 to $8 for a pack
      - .. image:: /docs/guides/images/jumper-wires.jpg
    ...
    * - :ref:`Breakable headers <pcb-headers>`
      ...
      - $3 to $8 for a pack
      - .. image:: /docs/guides/images/breakable-header.jpg
    ...
    * - :ref:`Wire snips, wire cutters, flush cutters <wire-snips>`
      ...
      - $5 to $15
      - .. image:: /docs/guides/images/wire-cutters.jpg
    ...
    * - :ref:`Wire strippers <wire-strippers>`
      ...
      - $5 to $15
      - .. image:: /docs/guides/images/strippers.jpg
    ...
    * - :ref:`Soldering iron <soldering-iron>`
      - Used to melt metal, called solder, to connect things together in an
        ...
        - TS100/TS80
      - $60 to $120
      - .. image:: /docs/guides/images/soldering-iron.jpg
    ...
    * - :ref:`Electronics solder <solder>`
      - Molten metal used to join things in an electrically conductive way.
        ...
        use here.
      - $8 to $12
      - .. image:: /docs/guides/images/solder.jpg
    ...
    * - :ref:`Electronics flux <soldering-flux>`
      ...
      - $8 to $12
      - .. image:: /docs/guides/images/flux.jpg
