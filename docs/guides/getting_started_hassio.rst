...
click on "EDIT" to open that file and add a :doc:`GPIO switch</docs/components/switch/gpio>` to the configuration like this:
...
.. figure:: /docs/components/switch/images/gpio-ui.png
    :align: center
    :width: 75.0%
...
Next, let's add a :doc:`binary sensor which will monitor a GPIO pin </docs/components/binary_sensor/gpio>` to determine and
report its state.
...
.. figure:: /docs/components/binary_sensor/images/gpio-ui.png
    :align: center
    :width: 75.0%
...
installed on your device) it can update the device :doc:`"over the air" </docs/components/ota/index>`.
