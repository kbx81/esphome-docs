...
The first is the :doc:`UDP Component </docs/components/udp>` which allows direct communication between ESPHome
...
Next is the :doc:`StatsD Component </docs/components/statsd>` which allows you to send sensor data
