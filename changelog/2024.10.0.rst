...
For those that use the :doc:`/docs/components/web_server` with version 3, there is a new
...
The :doc:`/docs/components/sensor/cse7766` now requires even parity in configuration. There are some chips that work without ``EVEN``,
