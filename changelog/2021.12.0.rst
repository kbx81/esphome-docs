...
This release brings :doc:`buttons </docs/components/button/index>` from Home Assistant. Many times there have been questions on how to simply trigger automations
...
sets the direction on the secondary MCU. See the :doc:`documentation </docs/components/cover/tuya>` for the new
