...
- Covers now support position & tilt - you can use these with the new :doc:`endstop </docs/components/cover/endstop>`
  and :doc:`time-based </docs/components/cover/time_based>` cover platforms.
...
- :doc:`Lights </docs/components/light/index>` now have some new actions: ``light.dim_relative`` and
...
- Added a new custom component mechanism and contribution guidelines have been updated. See the
  :doc:`contributing guide </docs/guides/contributing>` for more details.
- :doc:`RDM6300 </docs/components/binary_sensor/rdm6300>` now also has an ``on_tag`` trigger like the PN532.
- :doc:`Remote Transmitter </docs/components/remote_transmitter>` and :doc:`Remote Receiver </docs/components/remote_receiver>`
