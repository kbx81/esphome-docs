...
:doc:`LibreTiny </docs/components/libretiny>` is a platform for the RTL87xx and BK72xx family of chips. ESPHome leverages
...
:doc:`WireGuard </docs/components/wireguard>` is a new component that allows you to connect to a |wireguard| Peer.

LED Strips
----------

Following on from the previously added :doc:`/docs/components/light/esp32_rmt_led_strip`, we now have
:doc:`SPI LED Strips </docs/components/light/spi_led_strip>`. These are replacement components for
:doc:`/docs/components/light/neopixelbus` and :doc:`/docs/components/light/fastled` that
