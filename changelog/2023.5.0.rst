...
Following on from last months release adding :doc:`microphones </docs/components/microphone/index>`,
this release adds :doc:`speaker </docs/components/speaker/index>` support!

These new changes allows the :doc:`/docs/components/voice_assistant` to request the raw audio
stream response from Home Assistant to playback without using a full :doc:`/docs/components/media_player/index`.
...
See the :doc:`microphone documentation </docs/components/microphone/i2s_audio>` for the configuration details,
