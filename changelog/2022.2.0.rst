...
issues. See the :doc:`documentation </docs/components/light/fastled>` for information on how
...
Please see the :doc:`documentation </docs/components/debug>` page for the new way to configure them.
