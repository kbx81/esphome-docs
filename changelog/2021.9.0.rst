...
It was brought to our attention by :ghuser:`andir` that the :doc:`/docs/components/web_server` had a vulnerability in that
...
quite a few upgrades. Check the docs for the new features. :doc:`/docs/components/climate/midea`

SDM Meters
----------

:doc:`SDM Meters</docs/components/sensor/sdm_meter>` have been fixed to use kWh instead of Wh
