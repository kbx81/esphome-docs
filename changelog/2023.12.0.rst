...
Following on from the previous :doc:`/docs/components/display_menu/lcd_menu` that was only for LCD displays,
there is now a new :doc:`/docs/components/display_menu/graphical_display_menu` that can be used with any
