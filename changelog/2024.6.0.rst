...
In this ESPHome release, we added new triggers to the :doc:`Voice Assistant </docs/components/voice_assistant>` component
...
As part of this change also, :doc:`safe_mode </docs/components/safe_mode>` has been pulled out into its own top level component.
...
made a new top level :doc:`1-wire </docs/components/one_wire>` component that will allow for this.
...
The :doc:`http_request </docs/components/http_request>` platform has been rewritten in this release to
add support when using ESP-IDF or when using the :doc:`rp2040 </docs/components/rp2040>` platform. This will
...
This is mostly an internal change, but could be used by :doc:`external components </docs/components/external_components>`
or lambdas in YAML.
