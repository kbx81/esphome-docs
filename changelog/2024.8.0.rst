...
The :doc:`documentation </docs/components/lvgl/index>` is very extensive and hopefully we see
some awesome dashboards being made with it.

Online Image
------------

:ghuser:`guillempages` created a new :doc:`online_image </docs/components/online_image>` component that allows your ESPHome device to download
