...
See the :doc:`component documentation </docs/components/micro_wake_word>` for details on how to use it.
...
to continue using the BME280 over I2C. See the :doc:`component documentation </docs/components/sensor/bme280>` for the latest configuration variables.
