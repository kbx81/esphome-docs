...
ESPHome devices can now create :doc:`Select</docs/components/select/index>` entities in Home Assistant. This allows you to
...
:ghuser:`kbx81` Has made a few changes to the :doc:`thermostat</docs/components/climate/thermostat>` climate platform
...
There is a change with the :doc:`Anova BLE Souve</docs/components/climate/anova>` climate platform that has a new **required**
