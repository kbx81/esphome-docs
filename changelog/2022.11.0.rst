...
ESPHome will now preserve any credentials entered via the :doc:`/docs/components/captive_portal`, :doc:`/docs/components/improv_serial`
or :doc:`/docs/components/esp32_improv` components after an OTA update of the firmeware is done. It is possible they can survive
