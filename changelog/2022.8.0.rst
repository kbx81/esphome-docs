...
and keep those plants and veggies thriving. Check out the docs at :doc:`/docs/components/sprinkler`.

ST7789V
-------

The :doc:`/docs/components/display/st7789v` display platform has had an update which adds a ``model`` configuration option.
...
the :doc:`/docs/components/sensor/integration` and :doc:`/docs/components/sensor/total_daily_energy`.
