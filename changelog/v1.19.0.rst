...
:doc:`Improv Wi-Fi </docs/components/esp32_improv>` is a new standard that stands for **Improved Provisioning of Wi-Fi
...
in ESPHome and distribute them pre-installed and ready to use. See the :doc:`new page here </docs/guides/creators>`.
