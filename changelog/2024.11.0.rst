...
This release brings :doc:`/docs/components/opentherm` support to ESPHome. Please see the
:doc:`documentation </docs/components/opentherm>` for detailed information about it and how to use it.
